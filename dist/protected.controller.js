...
const jwt_auth_guard_1 = require("./app-security/jwt-auth.guard");
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard) // Protege la ruta con el guard
    ,
    (0, common_1.Get)(),
...
], ProtectedController.prototype, "getProtectedResource", null);
